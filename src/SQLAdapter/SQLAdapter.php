...
abstract class SQLAdapter {
	 ...
	 * @var array
	 */
	protected static $selectDefaults = array();//!< First element only (from ARR_ASSOC)
	/**
	 * Update defaults options
	 *
	 * @var array
	 */
	protected static $updateDefaults = array();//!< Array of associative arrays
	/**
	 * Delete defaults options
	 *
	 * @var array
	 */
	protected static $deleteDefaults = array();//!< Array of objects
	/**
	 * Insert defaults options
	 *
	 * @var array
	 */
	protected static $insertDefaults = array();//!< SQL Statement
	/**
	 * All Adapter instances by name
	 *
	 * @var array
	 */
	protected static $instances = array();//!< Query String
	/**
